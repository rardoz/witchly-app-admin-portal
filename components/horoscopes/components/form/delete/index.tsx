...
import deleteHoroscopeAction, {
  type DeleteHoroscopeState,
} from "@/actions/horoscope/delete";
import FormButton from "@/components/form/form-button";
import Modal from "@/components/modal";

const DeleteHoroscopeForm: React.FC<{ id: string }> = ({ id }) => {
  const router = useRouter();
  const [deleteState, deleteFormAction] = useActionState<
    DeleteHoroscopeState | null,
    FormData
  >(deleteHoroscopeAction, null);
...
export default DeleteHoroscopeForm;
