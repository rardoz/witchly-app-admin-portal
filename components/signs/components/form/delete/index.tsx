...
import deleteSignAction, { type DeleteSignState } from "@/actions/sign/delete";
import FormButton from "@/components/form/form-button";
import Modal from "@/components/modal";

const DeleteSignForm: React.FC<{ id: string }> = ({ id }) => {
  const router = useRouter();
  const [deleteState, deleteFormAction] = useActionState<
    DeleteSignState | null,
    FormData
  >(deleteSignAction, null);
