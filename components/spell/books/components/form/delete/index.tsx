...
import deleteSpellbookAction, {
  type DeleteSpellbookState,
} from "@/actions/spell/book/delete";
import FormButton from "@/components/form/form-button";
import Modal from "@/components/modal";

const DeleteSpellbookForm: React.FC<{ id: string }> = ({ id }) => {
  const router = useRouter();
  const [deleteState, deleteFormAction] = useActionState<
    DeleteSpellbookState | null,
    FormData
  >(deleteSpellbookAction, null);
...
export default DeleteSpellbookForm;
