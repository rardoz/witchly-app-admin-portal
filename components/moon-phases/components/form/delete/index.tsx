...
import deleteMoonPhaseAction, {
  type DeleteMoonPhaseState,
} from "@/actions/moon-phase/delete";
import FormButton from "@/components/form/form-button";
import Modal from "@/components/modal";

const DeleteMoonPhaseForm: React.FC<{ id: string }> = ({ id }) => {
  const router = useRouter();
  const [deleteState, deleteFormAction] = useActionState<
    DeleteMoonPhaseState | null,
    FormData
  >(deleteMoonPhaseAction, null);
...
export default DeleteMoonPhaseForm;
